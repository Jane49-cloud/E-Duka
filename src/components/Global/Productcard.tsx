...
function Productcard({
  ...
  return (
    <div
      className="max-w-sm rounded-lg bg-stone-100 radius-2xl h-fit mb-2  border border-gray-300"
      onClick={() => navigate(`/ad_info/${id}`)}
    >
      <img className="rounded-t-lg h-3/5 w-full object-cover" src={image} />
      <div className="px-3 py-2">
        <div className="flex flex-row justify-between text-md">
          <h1 className="text-slate-700 font-bold uppercase">{name}</h1>
